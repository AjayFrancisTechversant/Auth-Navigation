    ...
    return (
        <View style={screenStyles.canvas}>
            ...
            <View style={screenStyles.skeletonContainer}>
                <Skeleton animation='wave' skeletonStyle={screenStyles.boxSkeleton} width={20} />
                <Skeleton animation='wave' circle skeletonStyle={screenStyles.circleSkeleton} width={20}  />
