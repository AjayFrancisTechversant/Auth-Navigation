...
const styles = (screenContext, width, height) =>
  StyleSheet.create({
    ...
    thumbnailButtonContainer:{height:width*0.6,width:width*0.6,borderWidth:1,alignSelf:'center',margin:height*0.1,justifyContent:'center',alignItems:'center',borderRadius:10}
  });
